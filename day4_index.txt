...
public class C09_Character {
	...
	public static void main(String[] args) {
		...
		//¹®ÀÚÄÚµå Á¤¼ö°ª Ãâ·ÂÀº ? -> int ·Î Ä³½ºÆÃ(Çüº¯È¯ ÇÊ¿ä) : µÑ´Ù 97 Ãâ·Â
//		System.out.printf("c1 = %d\n" , c1);		// ¿À·ù : char ÇüÀº %d °¡ ¾Æ´Õ´Ï´Ù.
		...
		c1++;		//++ ¿¬»êÀº c1  = c1+1 , charÇü¿¡¼­´Â castingµµ ÇÕ´Ï´Ù.
		System.out.println("c1 = " + c1);
		...
		//hello Ãâ·ÂÇÏ·Á¸é char ÀÇ ¹è¿­·Î Ã³¸®ÇØ¾ßÇÕ´Ï´Ù ¹®ÀÚ¿­ÀÌ±â ¶§¹®
	}
 ...
 * 
 * 		±ä : ¤¡ ¤¿ ¤¤ (ÃÊ¼º, Áß¼º, Á¾¼º °¢°¢¿¡ ÄÚµå°ªÀ¸·Î Á¶ÇÕÇÏ´Â Á¶ÇÕÇü)
